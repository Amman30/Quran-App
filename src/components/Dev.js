    ...
    return (
        <div className="dev1">
            ...
            <div className="person1">
                ...
                Department of CSE
                IUST,KASHMIR
                {<a href="mailto:zubair.shah@islamicuniversity.edu.in">&nbsp;<i className="icon fa-solid fa-message"></i></a>}
            </div>
            <hr />
            ...
            <div className="person3">
                <Card className="card1" name="Mohammad Amman Ul Haq" contribution="Front-End Developer" />
                <h3 >
                    Student ,
                    Department of CSE &nbsp;
                    <br />
                    {<a href="https://github.com/Amman30"><i className="icon fa-brands fa-github"></i></a>}
                    {<a href="https://www.linkedin.com/in/mohammad-amman-5378ab20a"><i className="icon fa-brands fa-linkedin"></i></a>}</h3>
            </div>

            <div className="person3">
                <Card className="card1" name="Tabeed Hameed Ahangar" contribution="Back-End Developer" />
                <h3 >
                    Student ,
                    Department of CSE &nbsp;
                    <br />
